...
ZerocoinPage::ZerocoinPage(const PlatformStyle *platformStyle, Mode mode, QWidget *parent) :
    ...
    ui->labelExplanation->setText(
            tr("Here you can use your coin to mint a new, private Zerocoin or spend a previously-minted Zerocoin to a 3rd party GravityCoin address or your own wallet"));
